...
typedef struct iree_hal_amdgpu_device_wake_set_s {
...
void iree_hal_amdgpu_device_wake_set_initialize(
    iree_hal_amdgpu_wake_target_t self,
    IREE_OCL_GLOBAL iree_hal_amdgpu_device_wake_set_t* IREE_OCL_RESTRICT
        out_wake_set);
...
typedef struct iree_hal_amdgpu_device_wake_pool_s {
...
void iree_hal_amdgpu_device_wake_pool_initialize(
    iree_hal_amdgpu_wake_target_t target,
    IREE_OCL_GLOBAL iree_hal_amdgpu_device_wake_pool_t* IREE_OCL_RESTRICT
        out_wake_pool);
...
iree_hal_amdgpu_device_wake_pool_reserve(
    IREE_OCL_GLOBAL iree_hal_amdgpu_device_wake_pool_t* IREE_OCL_RESTRICT
        wake_pool,
    IREE_OCL_GLOBAL struct iree_hal_amdgpu_device_semaphore_s* semaphore);
