...
iree_hsa_signal_update_mailbox(
    const IREE_OCL_GLOBAL iree_amd_signal_t* IREE_OCL_RESTRICT signal) {
  IREE_OCL_GLOBAL iree_hal_amdgpu_device_atomic_uint64_t* mailbox =
      (IREE_OCL_GLOBAL iree_hal_amdgpu_device_atomic_uint64_t*)
...
static inline IREE_OCL_ATTRIBUTE_ALWAYS_INLINE int64_t
iree_hsa_signal_load(const iree_hsa_signal_t signal,
                     iree_hal_amdgpu_device_memory_order_t memory_order) {
  const IREE_OCL_GLOBAL iree_amd_signal_t* s =
      (const IREE_OCL_GLOBAL iree_amd_signal_t*)signal.handle;
  return iree_hal_amdgpu_device_atomic_load_explicit(
      (IREE_OCL_GLOBAL iree_hal_amdgpu_device_atomic_int64_t*)&s->value,
      memory_order, iree_hal_amdgpu_device_memory_scope_all_svm_devices);
}

static inline IREE_OCL_ATTRIBUTE_ALWAYS_INLINE void iree_hsa_signal_add(
    iree_hsa_signal_t signal, int64_t value,
    iree_hal_amdgpu_device_memory_order_t memory_order) {
  IREE_OCL_GLOBAL iree_amd_signal_t* s =
      (IREE_OCL_GLOBAL iree_amd_signal_t*)signal.handle;
  iree_hal_amdgpu_device_atomic_fetch_add_explicit(
      (IREE_OCL_GLOBAL iree_hal_amdgpu_device_atomic_int64_t*)&s->value, value,
      memory_order, iree_hal_amdgpu_device_memory_scope_all_svm_devices);
  iree_hsa_signal_update_mailbox(s);
}

static inline IREE_OCL_ATTRIBUTE_ALWAYS_INLINE void iree_hsa_signal_and(
    iree_hsa_signal_t signal, int64_t value,
    iree_hal_amdgpu_device_memory_order_t memory_order) {
  IREE_OCL_GLOBAL iree_amd_signal_t* s =
      (IREE_OCL_GLOBAL iree_amd_signal_t*)signal.handle;
...
static inline IREE_OCL_ATTRIBUTE_ALWAYS_INLINE void iree_hsa_signal_or(
    iree_hsa_signal_t signal, int64_t value,
    iree_hal_amdgpu_device_memory_order_t memory_order) {
  IREE_OCL_GLOBAL iree_amd_signal_t* s =
      (IREE_OCL_GLOBAL iree_amd_signal_t*)signal.handle;
...
static inline IREE_OCL_ATTRIBUTE_ALWAYS_INLINE void iree_hsa_signal_xor(
    iree_hsa_signal_t signal, int64_t value,
    iree_hal_amdgpu_device_memory_order_t memory_order) {
  IREE_OCL_GLOBAL iree_amd_signal_t* s =
      (IREE_OCL_GLOBAL iree_amd_signal_t*)signal.handle;
...
static inline IREE_OCL_ATTRIBUTE_ALWAYS_INLINE void iree_hsa_signal_subtract(
    iree_hsa_signal_t signal, int64_t value,
    iree_hal_amdgpu_device_memory_order_t memory_order) {
  IREE_OCL_GLOBAL iree_amd_signal_t* s =
      (IREE_OCL_GLOBAL iree_amd_signal_t*)signal.handle;
...
static inline IREE_OCL_ATTRIBUTE_ALWAYS_INLINE void iree_hsa_signal_store(
    iree_hsa_signal_t signal, int64_t value,
    iree_hal_amdgpu_device_memory_order_t memory_order) {
  IREE_OCL_GLOBAL iree_amd_signal_t* s =
      (IREE_OCL_GLOBAL iree_amd_signal_t*)signal.handle;
