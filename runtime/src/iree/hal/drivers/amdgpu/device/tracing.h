...
typedef struct iree_hal_amdgpu_trace_src_loc_s {
  IREE_OCL_CONSTANT const char* name;
  IREE_OCL_CONSTANT const char* function;
  IREE_OCL_CONSTANT const char* file;
  uint32_t line;
...
#define IREE_OCL_TRACE_BUFFER_DEFINE(trace_buffer)       \
  IREE_OCL_GLOBAL iree_hal_amdgpu_device_trace_buffer_t* \
      __iree_ocl_trace_buffer = (trace_buffer)
#define IREE_OCL_TRACE_BUFFER() (__iree_ocl_trace_buffer)

#else

#define IREE_OCL_TRACE_BUFFER_DEFINE(...)
#define IREE_OCL_TRACE_BUFFER() NULL
