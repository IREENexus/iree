...
enum iree_hal_amdgpu_device_host_call_e {
  // Host will retire the queue entry and enqueue the scheduler.
  //
  // Signature:
  //   arg0: uint64_t scheduler_queue_entry
  //   arg1: unused
  //   arg2: unused
  //   arg3: unused
